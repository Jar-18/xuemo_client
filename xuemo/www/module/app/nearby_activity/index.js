angular.module('starter.controllers')
    ...
    .controller('nearbyActivityCtrl', ['$scope','$state','activityService','URL_CONFIG','pagerService','$http',
        function($scope,$state,activityService,URL_CONFIG,pagerService,$http) {
        ...
        var listUrl=normalHost+URL_CONFIG.app.find.nearbyActivity.activityList[urlStatus];
        var listParams={
        ...
        $scope.refresh=function(){
            pagerService.refresh($scope.activityList,function(whetherLoadMore){
        ...
        $scope.showMore=function(){
            pagerService.nextPage($scope.activityList,function(whetherLoadMore){
